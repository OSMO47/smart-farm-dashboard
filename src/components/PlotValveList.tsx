          ...
          return (
            ...
            >
              ...
              <button
                ...
                disabled={disabled}
                className="w-[50px] h-[30px] rounded-full p-[3px] shrink-0 flex items-center transition-colors duration-200"
              ...
              >
                <span
                  ...
                  style={{ transform: plot.valveOpen ? 'translateX(20px)' : 'translateX(0)' }}
                />
              </button>
            </div>
          );
